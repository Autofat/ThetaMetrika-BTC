            ...
            <div class="rounded-md shadow-sm -space-y-px">
                <div>
                    ...
                    <input id="name" type="text" wire:model.defer="name" required
                        class="block w-full px-3 py-2 border @error('name') border-red-500 @else border-gray-300 @enderror 
                ...
                <div>
                    ...
                    <input id="email" type="email" wire:model.defer="email" required
                        class="block w-full px-3 py-2 border @error('email') border-red-500 @else border-gray-300 @enderror 
                ...
                <div>
                    ...
                    <input id="password" type="password" wire:model.defer="password" required
                        class="block w-full px-3 py-2 border @error('password') border-red-500 @else border-gray-300 @enderror 
                   placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
